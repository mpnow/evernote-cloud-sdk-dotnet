...
namespace EvernoteSDK
{
	namespace Advanced
	{
		...
		public class ENSessionAdvanced : ENSession
		{
			...
			//*/
			//Private Shared _sharedSession As New Lazy(Of ENSessionAdvanced)(Function() New ENSessionAdvanced())
			new public static ENSessionAdvanced SharedSession
			{
				get
				{
					...
					//ENSession.IsAdvancedInterface = True
		...
		public class ENSessionAdvancedCOM
		{
